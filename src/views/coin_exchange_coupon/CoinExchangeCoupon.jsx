...
export default function CoinExchangeCoupon() {
  ...
  return (
    <div className='coin_exchange_coupon'>
      <div className="title_bar">
        <TitleBar title='金币兑换' left={title_bar_left_icon} />
      </div>
        ...
        <div className="content_section_wrapper">
          <div className="content_main">
            <div className="coin_history_statistics_bar">
              金币数：<span className='color_red coin_history_statistics_bar_text'>999</span>
            </div>
            <div className="order_car_item">
              <GoodCouponCard btn_text='10000币'
                onClickBtn={e => {
                  e.stopPropagation()
